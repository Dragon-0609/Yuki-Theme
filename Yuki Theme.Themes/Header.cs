...
namespace Yuki_Theme.Themes
{
	public class Header : IThemeHeader
	{
		...
		public Dictionary <string, bool> ThemeNames => new ()
		{
			...
			{ "EVA: Rei", true },
			{ "Franxx: Hiro x Zero Two", true },
			{ "Franxx: Hiro", true },
			{ "Franxx: Zero Two Dark Obsidian", true },
			{ "Franxx: Zero Two Dark Rose", true },
			{ "Franxx: Zero Two Light Lily", true },
			{ "Franxx: Zero Two Light Sakura", true },
