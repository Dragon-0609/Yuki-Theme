	...
	class TipText : TipSection
	{
		...
		public override void Draw(PointF location)
		{
			if (IsTextVisible())
			{
				...
				{
					SizeF szfull = Graphics.MeasureString(tipText, tipFont,
						new SizeF(drawRectangle.Width, drawRectangle.Height), GetInternalStringFormat());

					SizeF sz1 = Graphics.MeasureString(tipText.Substring(0, beg_bold), tipFont,
						new SizeF(drawRectangle.Width, drawRectangle.Height), GetInternalStringFormat());
					...
					Graphics.DrawString(tipText.Substring(0, beg_bold), tipFont,
						...
						drawRectangle,
						GetInternalStringFormat());
					SizeF sz2 = Graphics.MeasureString(tipText.Substring(beg_bold, len_bold), fnt,
						new SizeF(drawRectangle.Width, drawRectangle.Height), GetInternalStringFormat());
					SizeF sz2_simp = Graphics.MeasureString(tipText.Substring(beg_bold, len_bold), tipFont,
						new SizeF(drawRectangle.Width, drawRectangle.Height), GetInternalStringFormat());
					...
					Graphics.DrawString(tipText.Substring(beg_bold, len_bold), fnt,
						...
						y_coord,
						GetInternalStringFormat());
					SizeF sz3 = Graphics.MeasureString(tipText.Substring(beg_bold + len_bold), tipFont,
						new SizeF(drawRectangle.Width, drawRectangle.Height), GetInternalStringFormat());
		...
		StringFormat CreateTipStringFormatForHeader(StringAlignment horizontalAlignment,
		...
		StringFormat CreateTipStringFormatForParameter(StringAlignment horizontalAlignment,
			StringAlignment verticalAlignment)
		{
