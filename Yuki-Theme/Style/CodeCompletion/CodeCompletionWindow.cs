...
namespace YukiTheme.Style.CodeCompletion
{
	public class YukiCodeCompletionWindow : AbstractCompletionWindow
	{
        ...
        public static YukiCodeCompletionWindow ShowCompletionWindow(Form parent, TextEditorControl control, string fileName, ICompletionDataProvider completionDataProvider, char firstChar, bool visibleKeyPressed, bool is_by_dot,PascalABCCompiler.Parsers.KeywordKind keyw)
		{
            ...
            YukiCodeCompletionWindow codeCompletionWindow = new YukiCodeCompletionWindow(completionDataProvider, completionData, parent, control, visibleKeyPressed, is_by_dot);
			codeCompletionWindow.ShowCompletionWindow();
			return codeCompletionWindow;
		}
		
        public static YukiCodeCompletionWindow ShowOverridableMethodsCompletionWindows(Form parent, TextEditorControl control, string fileName, ICompletionDataProvider completionDataProvider)
        {
        	...
        	YukiCodeCompletionWindow codeCompletionWindow = new YukiCodeCompletionWindow(completionDataProvider, completionData, parent, control, false, false);
        ...
        public static YukiCodeCompletionWindow ShowCompletionWindowWithFirstChar(Form parent, TextEditorControl control, string fileName, ICompletionDataProvider completionDataProvider, char firstChar, PascalABCCompiler.Parsers.KeywordKind keyw)
        {
            ...
            YukiCodeCompletionWindow codeCompletionWindow = new YukiCodeCompletionWindow(completionDataProvider, completionData, parent, control, true, false);
			codeCompletionWindow.ShowCompletionWindow();
			return codeCompletionWindow;
        }
