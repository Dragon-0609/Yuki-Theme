...
public abstract class Exporter
{
	...
	public void Export(string name)
	{
		...
		{
			if (Next == null) throw new NullReferenceException($"Exporter for {Next} not found");
	...
	{
		var theme = Path.Combine(_folder, "theme.xshd");
		if (File.Exists(theme)) File.Delete(theme);
