...
{
	public class CompilerController_ : IVisualPascalABCPlugin
	{
		public static string StringsPrefix = "VPP_COMPCONTR_";
		IVisualEnvironmentCompiler VisualEnvironmentCompiler;
		public CompilerInformation CompilerInformation = new CompilerInformation();
		...
		public string Name
		{
			get { return "Compiler Controller"; }
		}
		...
		public CompilerController_(IWorkbench Workbench)
		{
			...
			// VisualEnvironmentCompiler.StandartCompiler.InternalDebug.UseStandarParserForIntellisense =
			// CompilerInformation.cbUseStandarParserForInellisense.Checked;
		...
		public void GetGUI(List<IPluginGUIItem> MenuItems, List<IPluginGUIItem> ToolBarItems)
		{
			PluginGUIItem Item = new PluginGUIItem(StringsPrefix + "NAME", StringsPrefix + "DESCRIPTION",
				CompilerInformation.PluginImage.Image, CompilerInformation.PluginImage.BackColor, Execute);
			MenuItems.Add(Item);
			ToolBarItems.Add(Item);
			if ((ILDASMFileName = GetILDASMFileName()) != null)
			{
				Item = new PluginGUIItem(StringsPrefix + "RUN_ILDASM", StringsPrefix + "RUN_ILDASM",
					CompilerInformation.RunILDASMImage.Image, CompilerInformation.RunILDASMImage.BackColor, RunILDasm);
				MenuItems.Add(Item);
				ToolBarItems.Add(Item);
			}
			...
			{
				Item = new PluginGUIItem(StringsPrefix + "RUN_DBGCLR", StringsPrefix + "RUN_DBGCLR",
					CompilerInformation.RunDbgCLRImage.Image, CompilerInformation.RunDbgCLRImage.BackColor, RunDbgCLR);
				MenuItems.Add(Item);
				ToolBarItems.Add(Item);
			}
		}
