...
public class EditorAlterer
{
    ...
    {
        DatabaseManager.Instance.Save(SettingsConst.BgImage, !IDEAlterer.GetWallpaperVisibility());
        IDEAlterer.Alterer.UpdateWallpaperVisibility();
    }

    private void ToggleSticker(object sender, EventArgs e)
    {
        DatabaseManager.Instance.Save(SettingsConst.Sticker, !IDEAlterer.GetStickerVisibility());
        IDEAlterer.Alterer.UpdateStickerVisibility();
    }
