...
public class MenuReplacer
{
    ...
    {
        DatabaseManager.Instance.Save(SettingsConst.BG_IMAGE, !IDEAlterer.IsWallpaperVisible);
    ...
    {
        DatabaseManager.Instance.Save(SettingsConst.STICKER, !IDEAlterer.IsStickerVisible);
    ...
    {
        DatabaseManager.Instance.Save(SettingsConst.DISCRETE_MODE, !IDEAlterer.IsDiscreteActive);
        IDEAlterer.Instance.UpdateWallpaperVisibility();
        IDEAlterer.Instance.UpdateStickerVisibility();
        IDEAlterer.Instance.FocusEditorWindow();
    }
