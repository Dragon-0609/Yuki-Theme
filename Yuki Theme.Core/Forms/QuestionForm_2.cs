...
namespace Yuki_Theme.Core.Forms
{
	partial class QuestionForm_2 : Form
	{
		...
		public QuestionForm_2 ()
		{
			...
			Message.Text = API.API.Current.Translate ("messages.google.analytics");
			button2.Text = API.API.Current.Translate ("messages.buttons.accept");
			button1.Text = API.API.Current.Translate ("messages.buttons.decline");
		}
