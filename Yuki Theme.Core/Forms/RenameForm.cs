...
namespace Yuki_Theme.Core.Forms
{
	public partial class RenameForm : Form
	{
		public RenameForm ()
		{
			...
			button1.Text = API.API.Current.Translate ("main.tips.save");
			button2.Text = API.API.Current.Translate ("download.cancel");
			label1.Text = API.API.Current.Translate ("messages.rename.from") + ":";
			label2.Text = API.API.Current.Translate ("messages.rename.to") + ":";
			Text = API.API.Current.Translate ("messages.rename.title");
		}
