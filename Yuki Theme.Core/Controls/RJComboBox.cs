...
namespace CustomControls.RJControls
{
    ...
    public class RJComboBox : UserControl
    {
        ...
        private void CmbListOnDrawItem (object sender, DrawItemEventArgs e)
        {
            if (e.Index < 0) return;
            ...
            e.DrawBackground ();
            e.Graphics.DrawString (cmbList.Items [e.Index].ToString (), e.Font, new SolidBrush (listTextColor), e.Bounds);
