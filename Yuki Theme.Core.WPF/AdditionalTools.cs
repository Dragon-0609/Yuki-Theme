...
namespace Yuki_Theme.Core.WPF
{
	public static class AdditionalTools
	{
		...
		{
			questionWindow.SetTitle (API.CentralAPI.Current.Translate ("messages.google.analytics"));

			questionWindow.SetButtonContents (API.CentralAPI.Current.Translate ("messages.buttons.decline"), API.CentralAPI.Current.Translate ("messages.buttons.accept"), "");
