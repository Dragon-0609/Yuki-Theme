...
namespace YukiTheme.Style
{
	...
	internal class YukiDockPaneCaption : DockPaneCaptionBase
	{
		private sealed class InertButton : InertButtonBase
		{
			...
			private YukiDockPaneCaption m_dockPaneCaption;

			private YukiDockPaneCaption DockPaneCaption => m_dockPaneCaption;
		...
		private static Blend ActiveBackColorGradientBlend
		{
			get
			{
				if (_activeBackColorGradientBlend == null)
				{
					...
					blend.Factors = new float[] { 0F, 0.8F };
		...
		private void DrawCaption(Graphics g)
		{
			...
			{
				using (LinearGradientBrush brush = new LinearGradientBrush(ClientRectangle, ActiveBackColorGradientEnd, ActiveBackColorGradientBegin, LinearGradientMode.Horizontal))
				{
